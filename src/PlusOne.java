 ...
 *           represents the integer 123. Incrementing by one gives 123 + 1 =
 *           124. Thus, the result should be [1,2,4]. Example 2:
 * 
 ...
 *           the integer 9. Incrementing by one gives 9 + 1 = 10. Thus, the
 *           result should be [1,0].
 * 
 * 
 *           Constraints:
 * 
 *           1 <= digits.length <= 100 0 <= digits[i] <= 9 digits does not
